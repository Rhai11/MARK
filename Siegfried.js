...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`Jhiem Rhai`, '[ Jhiem Rhai ]');
        logger('Hey, thank you for using this Bot', '[ Jhiem Rhai ]');
        logger("Fixed by Jhiem Rhai", '[ Siegfried Sama ]');
        logger("FB: https://www.facebook.com/profile.php?id=100090094401681&mibextid=ZbWKwL", 'Fixed by Jhiem Rhai');
      var cron = require("node-cron");
